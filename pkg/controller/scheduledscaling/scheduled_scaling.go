...
func appendGeneric(schedules []v1.ScalingScheduler, typedSchedules ...interface{}) {
	for _, schedule := range typedSchedules {
		schedules = append(schedules, schedule.(v1.ScalingScheduler))
	}
}
